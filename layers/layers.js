...
lyr_p_kankyo_0.set('fieldLabels', {'fid': 'inline label - always visible', 'ラベル用': 'hidden field', '事業区分': 'hidden field', '系統処理区': 'hidden field', '処理区': 'hidden field', '処理分区': 'hidden field', '系統名称': 'hidden field', '路線番号': 'hidden field', '路線枝番': 'hidden field', '路線孫番': 'hidden field', '管渠番号': 'hidden field', '管渠枝番': 'hidden field', '管渠孫番': 'hidden field', '管渠孫々番': 'hidden field', '予備番号': 'hidden field', '雨汚種別': 'hidden field', '上流人孔規': 'hidden field', '上流_0': 'hidden field', '上流人孔番': 'hidden field', '上流管底高': 'hidden field', '上流土被り': 'hidden field', '下流人孔規': 'hidden field', '下流_0': 'hidden field', '下流人孔番': 'hidden field', '下流管底高': 'hidden field', '下流土被り': 'hidden field', '管渠材質': 'hidden field', '略称': 'hidden field', '管径': 'hidden field', '区間距離': 'hidden field', '区間距離補': 'hidden field', '区間距離単': 'hidden field', '管渠延長': 'hidden field', '勾配': 'hidden field', '管形状': 'hidden field', '流下方式': 'hidden field', '副管径': 'hidden field', '副管落差': 'hidden field', '副管材質': 'hidden field', '工法': 'hidden field', '年号': 'hidden field', '工事年': 'hidden field', '工事名': 'hidden field', '工事件名': 'hidden field', '工事期間（': 'hidden field', '工事_0': 'hidden field', '供用年月日': 'hidden field', '施工区分': 'hidden field', '施工年月日': 'hidden field', '竣工年月日': 'hidden field', '施工業者名': 'hidden field', '所在地': 'hidden field', '代表者': 'hidden field', '電話番号': 'hidden field', '告示番号': 'hidden field', '地域名称': 'hidden field', '備考': 'hidden field', '対図番号': 'hidden field', '調整年度': 'hidden field', '事業区分コ': 'hidden field', '系統_0': 'hidden field', '処理区コー': 'hidden field', '処理分区コ': 'hidden field', '系統名称コ': 'hidden field', '整備時事業': 'hidden field', '整備_0': 'hidden field', '整備時系統': 'hidden field', '整備_1': 'hidden field', 'システム管': 'hidden field', '上流システ': 'hidden field', '下流システ': 'hidden field', '接続システ': 'hidden field', '接続施設フ': 'hidden field', '調査年度': 'hidden field', '調査方法': 'hidden field', '実施状況': 'hidden field', 'R7追加調査': 'hidden field', '新路線番号': 'hidden field', '新系統名称': 'hidden field', '選択': 'hidden field', '点検頻度': 'inline label - always visible', 'Block': 'inline label - always visible', 'hms_管口テレビカメラ点検調査費(円/箇所)': 'inline label - always visible', 'hms_マンホール目視調査費(円/箇所)': 'inline label - always visible', 'hms_テレビカメラ調査費(円/m)': 'inline label - always visible', 'hms_点検調査費(円/m)': 'inline label - always visible', 'hms_設計委託費(円/m)': 'inline label - always visible', });
